	...
	def __llegada(self):
		try:
			...
			for i in range(1000):
				...
				# Llegada de los clientes con una distribución exponencial con media de 3 minutos:
...
print('Negocio de arepas. Escenario 3, el negocio tiene 3 meseros y aplica una estrategia que atraiga más clientes')
random.seed(SEMILLA)
